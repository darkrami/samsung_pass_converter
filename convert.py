...
def run_conversion(file_path, password, output_dir=None, output_filename=None):
    """
    Runs the decryption and conversion process.

    Args:
        file_path (str): Path to the Samsung Pass export file.
        password (str): Password for decryption.
        output_dir (str, optional): Directory to save output files. Defaults to the input file's directory.
        output_filename (str, optional): Name for the output CSV file. Defaults to 'spass.csv'.
    """
    ...
    if decrypted_data:
        ...
        export_bitwarden_csv(processed_data, output_csv_path)
        print(f"Bitwarden compatible CSV exported to: {output_csv_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", help="Directory to save the output file (optional).")
    parser.add_argument("--output-filename", help="Name of the output CSV file (optional).")
    args = parser.parse_args()

    run_conversion(args.export_file_path, args.password, args.output_dir, args.output_filename)
